...
- download [ngPost_v4.4-x86_64.AppImage](https://github.com/mbruel/ngPost/releases/download/v4.4/ngPost_v4.4-x86_64.AppImage)
...
PS: for older system with GLIBC < 2.24, here is a version compiled on Debian8 with GLIBC 2.19 and Qt v5.8.0: [ngPost_v4.4-x86_64_debian8.AppImage](https://github.com/mbruel/ngPost/releases/download/v4.4/ngPost_v4.4-x86_64_debian8.AppImage)


### Raspbian release (armhf for Raspberry PI)
- download [ngPost_v4.4-armhf.AppImage](https://github.com/mbruel/ngPost/releases/download/v4.4/ngPost_v4.4-armhf.AppImage)
...
### Windows installer
- just use the packager [ngPost_v4.4_x64_setup.exe](https://github.com/mbruel/ngPost/releases/download/v4.4/ngPost_v4.4_x64_setup.exe) or [ngPost_v4.4_x86_setup.exe](https://github.com/mbruel/ngPost/releases/download/v4.4/ngPost_v4.4_x86_setup.exe) for the 32bit version
...
- download [ngPost_v4.4.dmg](https://github.com/mbruel/ngPost/releases/download/v4.4/ngPost_v4.4.dmg)
- launch it using the same syntax than describe in the section above
- if you wish to keep the configuration file, edit the file **~/.ngPost** using [this model](https://raw.githubusercontent.com/mbruel/ngPost/master/ngPost.conf) (don't put the .conf extension)
